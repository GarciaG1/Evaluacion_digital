...
<form action="login.php" method="post">
            <div class="">
                <img src="imagenes/dibujo.png" alt="Chimore" width="75%" class="rounded mx-auto d-block">
            </div>
            <div class="input-group mb-1 p-3">
                      ...
                      <input name="usuario" type="password" class="form-control" placeholder="Ingresa tu Cédula de Identidad" aria-label="Nombre de Usuario" aria-describedby="basic-addon1" style="height: 3.5em;" autofocus required pattern="[0-9]{3,15}">
            </div>
<input type="hidden" name="cargo" value="4">
            <div class="input-group p-3 d-flex justify-content-between">
                ...
                <hr>
            <p class="text-right text-success" style="font-size: 9px; margin-bottom: -1em;"><em>Desarrollado por: Wilson Orellana</em></p>
...
<footer class=" footer text-white mt-2 pt-2">
      <div class="container-fluid p-3" style="background:-webkit-gradient(linear, 80% 20%, 10% 21%, from(#FFBE00), to(#FF4E28))">
        ...
        <h5 class="lead">Designed by: <i class="far fa-chess-knight fa-lg"></i> Wilson Orellana  <font class="text-dark"><b><i class="fal fa-copyright"></i> 2020</b></font></h5>
